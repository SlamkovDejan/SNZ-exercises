...
if __name__ == "__main__":
    ...
    test_data = [train_data[index] for index in range(len(train_data)) if index in test_indices]
    train_data = [train_data[index] for index in range(len(train_data)) if index not in test_indices]
    ...
    print(f'Tochnost na drvoto 1: {correctenss1}')
    print(f'Tochnost na drvoto 2: {correctenss2}')

    if correctenss1 == correctenss2:
        print('Drvata imaat ista tochnost')
    elif correctenss1 > correctenss2:
